...
#define LOG_TAG STRINGIFY(LOG_MODULE_NAME)
...
#define BT_DBG(fmt, ...) LOG_D(fmt, ##__VA_ARGS__) //LOG_DBG(fmt, ##__VA_ARGS__)
#define BT_ERR(fmt, ...) LOG_E(fmt, ##__VA_ARGS__) //LOG_ERR(fmt, ##__VA_ARGS__)
#define BT_WARN(fmt, ...) LOG_W(fmt, ##__VA_ARGS__) //LOG_WRN(fmt, ##__VA_ARGS__)
#define BT_INFO(fmt, ...) LOG_I(fmt, ##__VA_ARGS__) //LOG_INF(fmt, ##__VA_ARGS__)
